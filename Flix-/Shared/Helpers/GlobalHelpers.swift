...
let exampleMovie1 = Movie(
    ...
    year: 2020, 
    rating: "TV-MA",
    accentColor: .red, defaultEpisodeInfo: exampleEpisodeInfo1,
...
let exampleMovie3 = Movie(
    ...
    rating: "TV-MA",
    numberOfSeasons: 2,
    accentColor: .green, defaultEpisodeInfo: exampleEpisodeInfo1,
    creators: "Baran bo Odan, Jantje Fritoja",
    cast: "Louis Hoffman, Oliver Masucci, Jordis Triebel", 
...
let exampleMovie4 = Movie(
    ...
    rating: "TV-MA",
    numberOfSeasons: 3,
    accentColor: .yellow, defaultEpisodeInfo: exampleEpisodeInfo1,
    creators: "Baran bo Odan, Jantje Fritoja",
    cast: "Louis Hoffman, Oliver Masucci, Jordis Triebel", 
...
let exampleMovie6 = Movie(
    ...
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 5, accentColor: .purple, defaultEpisodeInfo: exampleEpisodeInfo1,
